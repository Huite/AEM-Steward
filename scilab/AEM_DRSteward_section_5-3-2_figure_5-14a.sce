...
title_author="AEM DRSteward Section 5.3.2, Figure 5.14a";
printf("  %s\n\n",title_author);
...
uniform_flow_specify([],[]); global uniform; uniform.coef_Phi0=0; uniform.coef_v0=-.5*exp(%i*%pi*.125);

solve_type=solve_type_Kutta(); solve_value=[];
z1=-1-%i; z2=1+%i;
