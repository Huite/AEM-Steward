...
title_author="AEM DRSteward Section 3.2.1, Figure 3.9a";
printf("  %s\n\n",title_author);
...
solve_z=[xmin+%i*ymin;xmin+%i*ymax;xmax+%i*ymin;xmax+%i*ymax]; 
solve_Phi=[2 2 1 1]';
uniform_flow_specify(solve_z,solve_Phi);
zc=0; r0=0.5; Phi_circle=1.2;
...
draw_flow_conduction(x,y,real(omega),[0.9-1e-8:.1:2],imag(omega),[-10:.1:10],xv,yv,real(v),imag(v));
