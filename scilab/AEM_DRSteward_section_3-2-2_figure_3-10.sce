...
title_author="AEM DRSteward Section 3.2.2, Figure 3.10";
printf("  %s\n\n",title_author);
...
// uncomment to display influence functions for series inside element
global circle
//circle(1).coef_in(1)=1; xv=0; yv=0; zv=0; v=zeros(zv);
circle(1).coef_in(2)=1;
//circle(1).coef_in(2)=%i;
//circle(1).coef_in(3)=1; 
//circle(1).coef_in(3)=%i; 
//circle(1).coef_in(4)=1; 
//circle(1).coef_in(4)=%i; 
