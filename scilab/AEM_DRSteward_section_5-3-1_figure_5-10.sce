...
title_author="AEM DRSteward Section 5.3.1, Figure 5.10";
printf("  %s\n\n",title_author);
...
global line
line(1).coef_single_layer(1)=1;
//line(1).coef_single_layer(2)=2;
//line(1).coef_single_layer(3)=3;
//line(1).coef_single_layer(4)=4;
