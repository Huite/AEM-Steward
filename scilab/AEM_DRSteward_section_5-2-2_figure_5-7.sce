...
title_author="AEM DRSteward Section 5.2.2, Figure 5.7";
printf("  %s\n\n",title_author);
...
global line
line(1).coef_double_layer(1)=%i;
//line(1).coef_double_layer(2)=%i;
//line(1).coef_double_layer(3)=%i;
//line(1).coef_double_layer(4)=%i;
