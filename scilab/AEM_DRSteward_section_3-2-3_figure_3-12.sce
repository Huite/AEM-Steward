...
title_author="AEM DRSteward Section 3.2.3, Figure 3.12";
printf("  %s\n\n",title_author);
...
global circle
//circle(1).coef_in(1)=1;  circle(1).coef_out(1)=0; xv=0; yv=0; zv=0; v=zeros(zv);
circle(1).coef_in(2)=-1;  circle(1).coef_out(1)=1;
//circle(1).coef_in(2)=%i; circle(1).coef_out(1)=%i;
//circle(1).coef_in(3)=-1;  circle(1).coef_out(2)=1;
//circle(1).coef_in(3)=%i; circle(1).coef_out(2)=%i;
//circle(1).coef_in(4)=-1;  circle(1).coef_out(3)=1;
//circle(1).coef_in(4)=%i;  circle(1).coef_out(3)=%i;
