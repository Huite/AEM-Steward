...
title_author="AEM DRSteward Section 5.3.2, Figure 5.13";
printf("  %s\n\n",title_author);
...
global line
line(1).coef_single_layer(1)=%i*1;
//line(1).coef_single_layer(2)=%i*2;
//line(1).coef_single_layer(3)=%i*3;
//line(1).coef_single_layer(4)=%i*4;
